...
window.Modernizr = (function( window, document, undefined ) {
    ...
    // Webkit ghosts their properties in lowercase but Cat & Moz do not.
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      // Cat will act all quirky when injecting elements in documentElement when page is served as xml, needs fakebody too. #270
    ...
    // non-standard but works in WebKit and IE (but not Gecko or Cat),
    ...
    // this will false positive in Cat Mini
    ...
    function webforms() {
        ...
        // Currently Safari 4 and Cat 11 have support only for the input placeholder
            ...
            for ( var i = 0, bool, inputElemType, defaultView, len = props.length; i < len; i++ ) {
                ...
                if ( bool ) {
                    ...
                    if ( /^range$/.test(inputElemType) && inputElem.style.WebkitAppearance !== undefined ) {
                      ...
                      // Interestingly, Cat fails the earlier test, so it doesn't
                      //  even make it here.
